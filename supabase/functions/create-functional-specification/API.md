...
```
POST /create-functional-specification
```
...
```
OPTIONS /create-functional-specification
```
...
```bash
curl -X POST https://your-project.supabase.co/functions/v1/create-functional-specification \
...
- Metadata includes `project_id` and `operation: 'create-functional-specification'` for tracking
